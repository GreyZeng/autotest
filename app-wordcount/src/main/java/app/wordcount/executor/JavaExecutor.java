...
import static git.autotest.utils.CmdUtil.cmd;
...
public class JavaExecutor implements Executor {
    ...
    public void compile(String mainFile) {
        ...
        String defaultClassPath = FileUtil.getFolder(mainFile);
    ...
    public long exec(String mainFile, String input) {
        ...
        return java(FileUtil.getFolder(mainFile), getCompileClassName(mainFile), input);
    }
